...
public class ReactiveSecurityConfig {
    ...
    private final ReactiveJwtAuthenticationManager reactiveJwtAuthenticationManager;
    private final ReactiveBearerTokenServerAuthenticationConverter tokenAuthenticationConverter;
    private final ReactiveAuthRateLimitWebFilter reactiveAuthRateLimitWebFilter;
    private final ObjectMapper objectMapper;
    private final List<String> allowedOrigins;

    public ReactiveSecurityConfig(
            ReactiveJwtAuthenticationManager reactiveJwtAuthenticationManager,
            ReactiveBearerTokenServerAuthenticationConverter tokenAuthenticationConverter,
            ReactiveAuthRateLimitWebFilter reactiveAuthRateLimitWebFilter,
            ObjectMapper objectMapper,
            @Value("${app.cors.allowed-origins}") String allowedOrigins
    ) {
        this.reactiveJwtAuthenticationManager = reactiveJwtAuthenticationManager;
    ...
    public SecurityWebFilterChain reactiveSecurityWebFilterChain(ServerHttpSecurity http) {
        AuthenticationWebFilter authenticationWebFilter =
                new AuthenticationWebFilter(reactiveJwtAuthenticationManager);
