...
public class ReservationController {
        ...
        public Mono<ResponseEntity<ReservationResponse>> checkout(
                        @Valid @RequestBody CreateReservationCheckoutRequest request) {
                return securityUtils.currentUserOrThrowReactive()
                                .flatMap(currentUser -> reactiveBlockingExecutor.call(
        ...
        public Mono<PagedResponse<ReservationResponse>> page(
                ...
                return securityUtils.currentUserOrThrowReactive()
                                .flatMap(currentUser -> reactiveBlockingExecutor.call(
                                                () -> reservationService.listPage(currentUser, page, size, status,
                                                                query)));
        }
